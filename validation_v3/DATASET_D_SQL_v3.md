...
sha256            6a199c7d15ef52baae01b4faec4eff3e2a59d7cd47b687acfb1c49adf47d1e2a
...
**1311** of **1326** pool tasks eligible.
...
```text
strings scanned   2623   (system prompt + every question + every gold_sql)
exposure_count    0
```
...
| check | result | detail |
|---|---|---|
| `nonzero_items` | PASS | 1311 D items |
...
| `gold_100pct_execution` | PASS | 0 execution failures across 1311 items |
| `identical_task_id_set_as_C` | PASS | 1311 task_ids, identical to train_C_answers_v3.jsonl |
...
| `join_counts_recorded` | PASS | arity 0: 751 · arity 1: 198 · arity 2: 362 |
| `only_eligible_operation_families` | PASS | operation families present: {'filter': 1311}, none held out |
