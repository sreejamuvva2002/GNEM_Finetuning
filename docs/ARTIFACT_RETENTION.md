...
## Pre-update staging — 2026-09-13

A private same-filesystem copy is staged at `.recovery/lab_update_2026-09-13/excluded_artifacts.tar` (12,011,888,640 bytes). Every regular artifact member was checked against the source bytes. The archive and private Codex snapshot remain ignored by Git. This is not an external backup: no surviving off-system destination is yet confirmed. See the recovery handoff.
