...
builder                      phase5_sqlite_v3.1_A002
finetune/phase5_build_sqlite.py  a399cedf7166eb2b68736df81607c2727c0d5a7248ae8daabeff44c507cfcca7
...
`certification_count` is excluded by the user-authorized A-002 exception; its source value remains in canonical data. `split`, `split_group`, latitude, longitude and graph metadata are equally absent — leakage-control metadata never becomes queryable data.
